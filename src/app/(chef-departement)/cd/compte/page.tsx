          ...
          <Card className='h-100'>
            <CardBody>
              ...
              <Form onSubmit={handleSaveInfo}>
                <FormGroup>
                  <Label for='cd-name'>Nom affiché</Label>
                  <Input id='cd-name' type='text' value={name} onChange={(e) => setName(e.target.value)} placeholder='Votre nom' />
                </FormGroup>
                <FormGroup>
                  <Label for='cd-email'>Adresse e-mail</Label>
                  <Input id='cd-email' type='email' value={email} onChange={(e) => setEmail(e.target.value)} placeholder='votre@email.com' />
                </FormGroup>
                <FormGroup>
                  <Label>Rôle</Label>
                  <Input type='text' value='Chef Département' disabled style={{ opacity: 0.6, cursor: 'not-allowed' }} />
                </FormGroup>
          ...
          <Card className='h-100'>
            <CardBody>
              ...
              <Form onSubmit={handleChangePassword}>
                <FormGroup>
                  <Label for='cd-pwd-current'>Mot de passe actuel</Label>
                  <PasswordInput id='cd-pwd-current' value={currentPwd} onChange={setCurrentPwd} placeholder='••••••••' />
                </FormGroup>
                <FormGroup>
                  <Label for='cd-pwd-new'>Nouveau mot de passe</Label>
                  <PasswordInput id='cd-pwd-new' value={newPwd} onChange={setNewPwd} placeholder='••••••••' />
                  <small className='text-muted'>Minimum 6 caractères.</small>
                </FormGroup>
                <FormGroup>
                  <Label for='cd-pwd-confirm'>Confirmer le mot de passe</Label>
                  <PasswordInput id='cd-pwd-confirm' value={confirmPwd} onChange={setConfirmPwd} placeholder='••••••••' />
                </FormGroup>
